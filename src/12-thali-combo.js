...
export function createThaliDescription(thali) {
  ...
  const typeLabel = thali.isVeg ? "Veg" : "Non-Veg";

  return `${thali.name.toUpperCase()} (${typeLabel}) - Items: ${thali.items.join(", ")} - Rs.${thali.price.toFixed(2)}`;
}
